...
if (isset($_SESSION['Username'])) {
    ...
    if ($do == 'Manage') {
        ...
        $stmt = $con->prepare("SELECT comments.*,users.Username,items.Name FROM comments INNER JOIN items ON items.Item_ID=comments.item_id INNER JOIN users ON users.UserID=comments.user_id ORDER BY c_id DESC");
        $stmt->execute();
